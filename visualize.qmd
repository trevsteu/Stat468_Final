...
gp_plot_4 <- all_data |> 
  ...
  labs(title = "Mean GP by Pick Number", subtitle = "Note the scales are different",
       ...
       caption = "Figure 5.3.4.3: Averaged GP and PS Values") + 
...
\[\^1\]: I initially tried to estimate pick value using a $k$-nearest neighbour algorithm, but it valued picks around pick 200 more than picks around 125 overall because of this.
