...
Instead of doing that, I'll save the predicted values to a csv:

```{r}
pred_vals_logist <- data.frame(overall = seq(1,224), 
                         pts = predict(logist_model, 
                                       data.frame(overall = seq(1,224))))

write.csv(pred_vals_logist, "pred_vals_logist.csv")
```
