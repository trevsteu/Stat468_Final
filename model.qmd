...
```{r}
(ps_plot + gp_plot) / (sr_plot + aps_plot)
```
...
lin_ps_plot <- ps_plot + geom_line(data = pred_vals, 
                    aes(x = overall, y = mean_ps), col = "red", lwd = 1.5)
lin_gp_plot <- gp_plot + geom_line(data = pred_vals, 
                    aes(x = overall, y = mean_gp), col = "red", lwd = 1.5)
lin_sr_plot <- sr_plot + geom_line(data = pred_vals, 
                    aes(x = overall, y = suc_rate), col = "red", lwd = 1.5)
lin_aps_plot <- aps_plot + geom_line(data = pred_vals, 
...
nls_ps_plot <- ps_plot + geom_line(data = pred_vals, 
                    aes(x = overall, y = pred_mean_ps), col = "red", lwd = 1.5)
nls_gp_plot <- gp_plot + geom_line(data = pred_vals, 
                    aes(x = overall, y = pred_mean_gp), col = "red", lwd = 1.5)
nls_sr_plot <- sr_plot + geom_line(data = pred_vals, 
                    aes(x = overall, y = pred_suc_rate), col = "red", lwd = 1.5)
nls_aps_plot <- aps_plot + geom_line(data = pred_vals, 
