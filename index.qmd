...
-   `PS`: the player's estimated point share, or career points addedto their team (here we mean points in the standings, not goals and assists). There is more info on point share [here](https://www.hockey-reference.com/about/point_shares.html). \\end{itemize} \`\`\` Note that we will only use a subset of these columns, as will be explained in the [Tidy chapter](https://trevsteu.github.io/Stat468_Final/tidy.html).
