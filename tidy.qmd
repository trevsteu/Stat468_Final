...
# running it with tidy_draft will take a long time to run and render, 
...
In future chapters, we will import data from this csv file to speed up the run and rendering times. Now we proceed to the Visualize step.
