...
We compare the first 10 rows of the 1996 draft table shown above with the [table on Hockey Reference](https://www.hockey-reference.com/draft/NHL_1996_entry.html) It seems that the function we created does what we want it to do.
